...
use As247\Fact\Carbon\Exceptions\ImmutableException;
...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
     ...
     *
     * @param Carbon|\As247\Fact\Carbon\CarbonPeriod|\As247\Fact\Carbon\CarbonInterval|\DateInterval|\DatePeriod|DateTimeInterface|string|null $date
     *
     * @return static
     */
