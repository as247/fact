...
return [
    ...
    'calendar' => [
        'sameDay' => '[今日] LT',
        'nextDay' => '[明日] LT',
        'nextWeek' => function (\As247\Fact\Carbon\CarbonInterface $current, \As247\Fact\Carbon\CarbonInterface $other) {
        ...
        'lastDay' => '[昨日] LT',
        'lastWeek' => function (\As247\Fact\Carbon\CarbonInterface $current, \As247\Fact\Carbon\CarbonInterface $other) {
            if ($other->week !== $current->week) {
                return '[先週]dddd LT';
            }
