 ...
 */
namespace As247\Fact\Carbon;

use As247\Fact\Carbon\Exceptions\InvalidCastException;
use As247\Fact\Carbon\Exceptions\InvalidIntervalException;
use As247\Fact\Carbon\Exceptions\InvalidPeriodDateException;
use As247\Fact\Carbon\Exceptions\InvalidPeriodParameterException;
use As247\Fact\Carbon\Exceptions\NotACarbonClassException;
use As247\Fact\Carbon\Exceptions\NotAPeriodException;
use As247\Fact\Carbon\Exceptions\UnknownGetterException;
use As247\Fact\Carbon\Exceptions\UnknownMethodException;
use As247\Fact\Carbon\Exceptions\UnreachableException;
use As247\Fact\Carbon\Traits\IntervalRounding;
use As247\Fact\Carbon\Traits\Mixin;
use As247\Fact\Carbon\Traits\Options;
use Closure;
use Countable;
use DateInterval;
use DatePeriod;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     * @var string
     */
    const RECURRENCES_FILTER = 'As247\Fact\Carbon\CarbonPeriod::filterRecurrences';
    const END_DATE_FILTER = 'As247\Fact\Carbon\CarbonPeriod::filterEndDate';
     ...
     * @var string
     */
    const END_ITERATION = 'As247\Fact\Carbon\CarbonPeriod::endIteration';
     ...
     *
     * @param \As247\Fact\Carbon\Carbon|\As247\Fact\Carbon\CarbonPeriod|\As247\Fact\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \As247\Fact\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \As247\Fact\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \As247\Fact\Carbon\Carbon|\As247\Fact\Carbon\CarbonPeriod|\As247\Fact\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \As247\Fact\Carbon\CarbonInterface
     */
