...
trait Test
{
     ...
     * @param \As247\Fact\Carbon\CarbonInterface $testInstance
     *
     ...
     * @param string|\DateTimeZone $tz
     *
     * @return \As247\Fact\Carbon\CarbonImmutable|\As247\Fact\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \As247\Fact\Carbon\CarbonImmutable|\As247\Fact\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \As247\Fact\Carbon\CarbonImmutable|\As247\Fact\Carbon\Carbon $testInstance */
