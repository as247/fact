 ...
 */
namespace As247\Fact\Carbon\Traits;

use BadMethodCallException;
use As247\Fact\Carbon\CarbonInterface;
use As247\Fact\Carbon\Exceptions\BadComparisonUnitException;
...
trait Comparison
{
     ...
     * ```
     *
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|mixed $date
     *
     * @see equalTo()
     *
     * @return bool
     ...
     * ```
     *
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|mixed $date1
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|mixed $date2
     ...
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|string|null $date   instance to compare with or null to use current day.
     *
     * @return bool
     */
     ...
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|null $date instance to compare with or null to use current day.
     *
     ...
     * ```
     *
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|string|null $date       The instance to compare with or null to use current day.
     ...
     * ```
     *
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|null $date       The instance to compare with or null to use the current date.
     * @param bool                                   $ofSameYear Check if it is the same month in the same year.
     *
     * @return bool
     */
     ...
     * ```
     *
     * @param \As247\Fact\Carbon\Carbon|\DateTimeInterface|null $date The instance to compare with or null to use current day.
     *
     * @return bool
     */
