...
use As247\Fact\Carbon\Carbon;
use As247\Fact\Carbon\CarbonImmutable;
use As247\Fact\Carbon\CarbonInterface;
use As247\Fact\Carbon\Exceptions\InvalidDateException;
use As247\Fact\Carbon\Exceptions\InvalidFormatException;
use As247\Fact\Carbon\Exceptions\OutOfRangeException;
use As247\Fact\Carbon\Translator;
use Closure;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \As247\Fact\Carbon\CarbonImmutable|\As247\Fact\Carbon\Carbon|null $mock */
