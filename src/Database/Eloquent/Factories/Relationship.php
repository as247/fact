...
namespace As247\Fact\Database\Eloquent\Factories;

use As247\Fact\Database\Eloquent\Model;
use As247\Fact\Database\Eloquent\Relations\BelongsToMany;
use As247\Fact\Database\Eloquent\Relations\HasOneOrMany;
use As247\Fact\Database\Eloquent\Relations\MorphOneOrMany;
...
class Relationship
{
     ...
     *
     * @var \As247\Fact\Database\Eloquent\Factories\Factory
     */
    protected $factory;
     ...
     *
     * @param  \As247\Fact\Database\Eloquent\Factories\Factory  $factory
