...
use As247\Fact\Contracts\Database\Eloquent\Castable;
use As247\Fact\Contracts\Database\Eloquent\CastsInboundAttributes;
use As247\Fact\Contracts\Support\Arrayable;
use As247\Fact\Database\Eloquent\InvalidCastException;
use As247\Fact\Database\Eloquent\JsonEncodingException;
use As247\Fact\Database\Eloquent\Relations\Relation;
use As247\Fact\Support\Arr;
use As247\Fact\Support\Carbon;
use As247\Fact\Support\Collection as BaseCollection;
use As247\Fact\Support\Facades\Date;
...
trait HasAttributes
{
     ...
     *
     * @param  mixed  $value
     * @return \As247\Fact\Support\Carbon
     */
     ...
     * @return bool
     *
     * @throws \As247\Fact\Database\Eloquent\InvalidCastException
     */
