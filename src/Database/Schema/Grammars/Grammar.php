...
namespace As247\Fact\Database\Schema\Grammars;

use Doctrine\DBAL\Schema\AbstractSchemaManager as SchemaManager;
use Doctrine\DBAL\Schema\TableDiff;
use As247\Fact\Database\Connection;
use As247\Fact\Database\Grammar as BaseGrammar;
use As247\Fact\Database\Query\Expression;
use As247\Fact\Database\Schema\Blueprint;
...
abstract class Grammar extends BaseGrammar
{
     ...
     * @param  \As247\Fact\Support\Fluent  $command
     ...
     *
     * @param  \As247\Fact\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \As247\Fact\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \As247\Fact\Support\Fluent|null
     */
     ...
     *
     * @param  \As247\Fact\Database\Query\Expression|string  $value
