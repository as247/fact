...
use As247\Fact\Database\Schema\Grammars\Grammar;
use As247\Fact\Database\SQLiteConnection;
use As247\Fact\Support\Fluent;
...
class Blueprint
{
     ...
     *
     * @var \As247\Fact\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @return \As247\Fact\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \As247\Fact\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \As247\Fact\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \As247\Fact\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \As247\Fact\Database\Eloquent\Model|string  $model
